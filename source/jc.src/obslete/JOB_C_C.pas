...
begin
  Application.CreateForm(TfmJOB_DAILY_SUMMARY,fmJOB_DAILY_SUMMARY);
  try
    fmJOB_DAILY_SUMMARY.ShowModal;
  finally
    fmJOB_DAILY_SUMMARY.Release;
  end;
end;
...
procedure TfmCostCat.dgrJOB_COST_CATCheckValue(Sender: TObject;
  PassesPictureTest: Boolean);
begin
  with fmJOB_COST_CAT,dmJCdata do
  begin
