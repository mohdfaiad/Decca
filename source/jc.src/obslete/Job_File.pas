...
var
  fmJobDetail: TfmJobDetail;

implementation
  uses JCdatadm;
{$R *.DFM}

procedure TfmJobDetail.FormCreate(Sender: TObject);
begin
...
procedure TfmJobDetail.sbExitClick(Sender: TObject);
begin
  Close;
end;

procedure TfmJobDetail.sbPrintscreenClick(Sender: TObject);
begin
  print;
end;

procedure TfmJobDetail.printSetupClose(Sender: TObject);
begin
  printSetup.Execute;
end;
